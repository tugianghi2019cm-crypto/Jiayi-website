 ...
 * - Every other `getXConfig()` validates one feature/integration
 *   group on demand. None of them are called anywhere yet — the
 *   features themselves are not implemented in this task. Because
 *   nothing calls them, an unset `DATABASE_URL`, `GOOGLE_CLIENT_ID`,
 *   etc. cannot break the build or any unrelated route.
...
/**
 * Database config contract. NOT called anywhere yet — DB-001 will
 * call this once it actually connects to PostgreSQL.
 */
